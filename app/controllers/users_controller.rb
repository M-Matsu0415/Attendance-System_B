class UsersController < ApplicationController
  ...
  before_action :correct_user, only: [:edit, :create, :show, :edit_basic_info, :attendance_log_all, :attendance_log_search, :edit_basic_info, :reference_month_approval, :reference_change_or_overwork]
  before_action :admin_or_correct_user_for_month, only: :create_month_approval
  before_action :admin_or_correct_user, only: :create_month_approval
  before_action :admin_user, only: [:destroy, :working_members, :index]
